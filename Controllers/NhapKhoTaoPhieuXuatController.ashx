<%@ WebHandler Language="C#" Class="NhapKhoTaoPhieuXuatController" %>

using System;
using System.Web;
using System.Linq;

public class NhapKhoTaoPhieuXuatController : IHttpHandler {
    ...
    public void load(HttpContext context)
    {
        ...
        String sqlCount = "SELECT COUNT(*) AS count " +
            ...
            " WHERE 1=1 " +
            " {0} " + 
			" and nx.cr_phieuxuat = 0 " +
            " AND nx.md_loaichungtu_id = N'NK' AND nx.md_trangthai_id ='HIEULUC' " + filter;
        ...
        string strsql = "select * from( " +
            ...
            "   , nx.soseal, nx.socontainer, nx.loaicont " +
