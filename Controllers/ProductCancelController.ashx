<%@ WebHandler Language="C#" Class="ProductCancelController" %>
...
public class ProductCancelController : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (action)
        {
            case "updatestatus":
                ...
                break;
			case "updatestatusALL_HH":
                this.updatestatusALL_HH(context);
                break;
	...
	public void updatestatusALL_HH(HttpContext context)
    {
        String msg = "";
    ...
    public void load(HttpContext context)
    {
        ...
        String sqlCount = @"SELECT COUNT(*) AS count 
            ...
            WHERE 
	            1=1 " +
                " {0} " +
                " AND sp.hoatdong = 1 AND sp.trangthai = 'HHH'";
