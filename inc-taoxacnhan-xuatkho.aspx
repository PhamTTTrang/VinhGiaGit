<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inc-taoxacnhan-xuatkho.aspx.cs" Inherits="inc_taoxacnhan_xuatkho" %>
                ...
                [
                    {
                        ...
                        click: function() {
                           ...
                           $.ajax({
                                 url: "Controllers/LamPhieuXacNhanXuat.ashx",
                                 type: "POST",
                                 datetype: "json",
                                 data: { grid_form: postData, action: "SaveXacNhanXuat" },
                                 error: function(rs) {
...
<div class="ui-layout-north" id="lay-north-phieunhapxuat">
    <uc1:jqGrid  ID="grid_ds_po_phieunhapxuat" 
            ...
            AfterRefresh = "function(){ 
                ...
                jQuery('#grid_ds_chitietpo_phieunhapxuat').jqGrid().trigger('reloadGrid');
            }"
