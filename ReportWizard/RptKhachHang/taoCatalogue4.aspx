<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taoCatalogue4.aspx.cs" Inherits="ReportWizard_RptKhachHang_taoCatalogue4" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="trangchinhcatalog4.rdlc">
                <DataSources>
