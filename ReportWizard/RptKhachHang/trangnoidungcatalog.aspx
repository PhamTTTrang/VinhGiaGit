<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trangnoidungcatalog.aspx.cs" Inherits="ReportWizard_RptKhachHang_trangnoidungcatalog" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="trangnoidungcatalog.rdlc">
                <DataSources>
