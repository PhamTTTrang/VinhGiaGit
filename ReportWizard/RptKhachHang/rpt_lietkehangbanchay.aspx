<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_lietkehangbanchay.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_lietkehangbanchay" %>
...
<body>
    ...
    <div id="rpt-container" >
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="rpt_lietkehangbanchay.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_lietkehangbanchay" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_lietkehangbanchay" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_lietkehangbanchayTableAdapter">
            <SelectParameters>
