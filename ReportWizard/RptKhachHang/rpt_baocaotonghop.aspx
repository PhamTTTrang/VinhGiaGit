<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_baocaotonghop.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_baocaotonghop" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="rpt_baocaotonghopbgd.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_baocaotonghopbgd" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_baocaotonghopbgd" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_baocaotonghopbgdTableAdapter">
            <SelectParameters>
