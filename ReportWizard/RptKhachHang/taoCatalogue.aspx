<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taoCatalogue.aspx.cs" Inherits="ReportWizard_RptKhachHang_taoCatalogue" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="trangchinhcatalog.rdlc">
                <DataSources>
