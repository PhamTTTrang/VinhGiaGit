<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_chitietcongnokhachhang.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_chitietcongnokhachhang" %>
...
<body>
    ...
    <div id="rpt-container" style="display:none">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="rpt_chitietcongnokhachhang.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_chitietcongnokhachhang" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_chitietcongnokhachhang" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_chitietcongnokhachhangTableAdapter">
            <SelectParameters>
