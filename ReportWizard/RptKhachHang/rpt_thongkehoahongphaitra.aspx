<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_thongkehoahongphaitra.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_thongkehoahongphaitra" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="rpt_tinhtienhoahongphaitra.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_thongkehoahongphaitra" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_thongkehoahongphaitra" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_thongkehoahongphaitraTableAdapter">
            <SelectParameters>
