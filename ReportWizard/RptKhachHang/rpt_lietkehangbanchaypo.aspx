<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_lietkehangbanchaypo.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_lietkehangbanchaypo" %>
...
<body>
    ...
    <div id="rpt-container" >
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="rpt_lietkehangbanchay_po.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_lietkehangbanchaypo" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_lietkehangbanchaypo" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_lietkehangbanchaypoTableAdapter">
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="enddate" QueryStringField="enddate" 
                    Type="DateTime" />
                <asp:QueryStringParameter Name="chungloai_id" QueryStringField="hehang_id" 
                    Type="String" />
