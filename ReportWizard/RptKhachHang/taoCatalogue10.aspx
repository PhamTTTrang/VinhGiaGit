<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taoCatalogue10.aspx.cs" Inherits="ReportWizard_RptKhachHang_taoCatalogue10" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="trangchinhcatalog10.rdlc">
                <DataSources>
