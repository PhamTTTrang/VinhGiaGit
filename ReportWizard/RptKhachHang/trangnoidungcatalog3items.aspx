<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trangnoidungcatalog3items.aspx.cs" Inherits="ReportWizard_RptKhachHang_trangnoidungcatalog3items" %>
...
<body>
    ...
    <div id="rpt-container">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <localreport reportpath="trangnoidungcatalog3items.rdlc">
                <datasources>
