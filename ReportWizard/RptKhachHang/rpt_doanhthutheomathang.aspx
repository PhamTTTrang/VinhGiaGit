<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_doanhthutheomathang.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_doanhthutheomathang" %>
...
<body>
    ...
    <div id="rpt-container" style="display:none">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="580px" Width="860px">
            <LocalReport ReportPath="rpt_doanhthutheotungmathang.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_doanhthutheomahang" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_doanhthutungloaimathang" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_doanhthutheomahangTableAdapter">
            <SelectParameters>
