<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_doanhsotheonhanvien.aspx.cs" Inherits="ReportWizard_RptKhachHang_rpt_doanhsotheonhanvien" %>
...
<body>
    ...
    <div id="rpt-container" style="display:none">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="580px" Width="1024px">
            <LocalReport ReportPath="rpt_doanhsotheotungnhanvien.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_doanhsotheonhanvien" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_doanhsotheotungnhanvien" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_doanhsotheonhanvienTableAdapter">
            <SelectParameters>
