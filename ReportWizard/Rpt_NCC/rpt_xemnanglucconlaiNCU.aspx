<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_xemnanglucconlaiNCU.aspx.cs" Inherits="ReportWizard_Rpt_NCC_rpt_xemnanglucconlaiNCU" %>
...
<body>
    ...
    <div id="rpt-container" style="display">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="560px" Width="860px">
            <LocalReport ReportPath="rpt_xemnanglucconlai.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                        Name="anco_test_importDataSet_rpt_xemnanglucsanxuatconlai" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" 
            SelectMethod="rpt_xemnanglucsanxuatconlai" 
            TypeName="anco_test_importDataSetTableAdapters.rpt_xemnanglucsanxuatconlaiTableAdapter">
            <SelectParameters>
