<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cbm_phanloaihehang.ascx.cs" Inherits="cbm_phanloaihehang" %>
<%@ Import Namespace="System.Linq" %>
<%@ Import Namespace="System.Xml.Linq" %>
<%
    LinqDBDataContext db = new LinqDBDataContext();
    var query = from i in db.md_phanloaihhs 
                orderby i.code_pl
                select new { value = i.md_phanloaihh_id, name = (i.code_pl + " || " + i.ta_ngan)};
%>
