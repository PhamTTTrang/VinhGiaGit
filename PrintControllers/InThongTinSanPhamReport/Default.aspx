<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="PrintControllers_InThongTinSanPhamReport_Default" %>
...
<body>
    ...
    <div>
        ...
        <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="rptThongTinSanPham">
        </dx:ReportViewer>
