...
public partial class PrintControllers_InXacNhanBaoBi_Default : System.Web.UI.Page
{
    ...
    {
        String md_donhang_id = Request.QueryString["c_danhsachdathang_id"];
    ...
    public String CreateSql(String c_danhsachdathang_id)
    {
        String str = String.Format(@"select 
                                    ...
                                    where 
	                                    ...
	                                    and pi_.c_danhsachdathang_id = '{0}'", c_danhsachdathang_id == null ? "" : c_danhsachdathang_id);
        return str;
    }
}
