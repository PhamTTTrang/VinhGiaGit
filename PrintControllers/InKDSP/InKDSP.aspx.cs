...
public partial class PrintControllers_InKDSP_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		select
			kd.ma_kieudang as [Mã Kiểu Dáng], kd.ten_tv as [Tên Tiếng Việt],
			kd.ten_ta as [Tên Tiếng Anh], kd.mota as [Ghi chú]
		from md_kieudang kd
		where 1=1 {0}", filter);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            s1.CreateRow(0).CreateCell(0).SetCellValue("KIỂU DÁNG");
            ...
            String saveAsFileName = "KieuDang.xls";
