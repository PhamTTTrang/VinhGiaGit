...
public partial class PrintControllers_InCNSP_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		select
			cn.ma_chucnang as [Mã Chức Năng], cn.ten_tv as [Tên Tiếng Việt],
			cn.ten_ta as [Tên Tiếng Anh], cn.mota as [Ghi chú]
		from md_chucnang cn
		where 1=1 {0}", filter);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            s1.CreateRow(0).CreateCell(0).SetCellValue("Chức năng");
            ...
            String saveAsFileName = "ChucNang.xls";
