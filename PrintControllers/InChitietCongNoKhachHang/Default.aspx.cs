...
public partial class PrintControllers_InChitietCongNoKhachHang_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rpt_chitietcongnokhachhang report = new rpt_chitietcongnokhachhang();
    ...
    public String CreateSql(string startdate, string enddate, string md_doitackinhdoanh_id)
    {
		...
		string str = String.Format(@"exec [dbo].[rpt_chitietcongnokhachhang] N'{0}',N'{1}',{2}", startdate, enddate, md_doitackinhdoanh_id);
        return str;
    }
}
