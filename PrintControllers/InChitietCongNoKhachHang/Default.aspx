<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="PrintControllers_InChitietCongNoKhachHang_Default" %>
...
<body>
    ...
    <div align=center>
        ...
        <dx:ReportViewer ID="ReportViewer1" runat="server" ReportName="ReportViewer1">
        </dx:ReportViewer>
        <br />
    </div>
    </form>
