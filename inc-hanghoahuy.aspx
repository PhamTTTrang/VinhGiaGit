<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inc-hanghoahuy.aspx.cs" Inherits="inc_hanghoahuy" %>
<%@ Register src="jqGrid.ascx" tagname="jqGrid" tagprefix="uc1" %>
<script>
    $(function() {
		setTimeout(function () {
            $('#grid_ds_sanphamhuy-pager_left table tr').append(
                '<td class="ui-pg-button ui-corner-all" title="Chuyển trạng thái nhanh" id="ctt_grid_ds_sanphamhuy">' +
                '<div class="ui-pg-div"><span onclick="ChangeStatusALL_HHH()" class="ui-icon ui-icon-circle-plus"></span></div><td>')
            , 5000
        });
		
        $('#lay-center-sanphamhuy').parent().layout({
            south: {
                size: "40%"
                    , minSize: "0%"
                    , maxSize: "100%"
                    , onresize_end: function() {
                        var h = $("#lay-south-sanphamhuy").height();

                        // sett height
                        $("#grid_ds_quycachdonggoihuy").setGridHeight(h + 4 - 80);
                        $("#grid_ds_giafobhuy").setGridHeight(h + 4 - 80);
                        $("#grid_ds_khachhangdocquyen_sphuy").setGridHeight(h + 4 - 80);
                        $("#grid_ds_cangxuathanghuy").setGridHeight(h + 4 - 80);
                    }
            }
            , center: {
                onresize_end: function() {
                    var h = $("#lay-center-sanphamhuy").height();
                    var w = $("#lay-center-sanphamhuy").width();
                    $("#grid_ds_sanphamhuy").setGridHeight(h + 4 - 70);
                }
            }
        });
        $('#lay-south-sanphamhuy').layout({
            center: {
                onresize_end: function() {
                var w = $("#tab-product-detailshuy").width();
                    //set width
                $("#grid_ds_quycachdonggoihuy").setGridWidth(w);
                $("#grid_ds_giafobhuy").setGridWidth(w);
                $("#grid_ds_khachhangdocquyen_sphuy").setGridWidth(w);
                $("#grid_ds_cangxuathanghuy").setGridWidth(w);
                }
            },
            east: {
                size: 200
        ...
        $('#tab-product-detailshuy').tabs();
    });
	
	function ChangeStatusALL_HHH() {
        $('body').append("<div title=\"Thay đổi trạng thái cho sản phẩm\" id=\"dialog-changestatus\">" +
            ...
            "<table>" +
                ...
                "<tr>" +
                    ...
                    "</td>" +
                    "<td>" +
                        "<label for=\"hhh\">Tiêu hủy hàng hóa (Bạn đã chắc chắn?)</label>" +
                    "</td>" +
                "</tr>" +
            "</table>" +
        "</div>");
                ...
                , buttons: [
                {
                    ...
                    click: function () {
                        ...
                        if (typeof statusType != 'undefined') {
							...
							{ filters : $('#grid_ds_sanphamhuy').getGridParam("postData").filters, trangthai_ht:'HHH' },
							function (result) {
								$("#wait").css("display", "none");
                                $("#btn-close span").text("Thoát");
                                $("#btn-close").button("enable");
                                $("#dialog-changestatus").find("#caution").append(result);
                                $('#grid_ds_sanphamhuy').jqGrid().trigger('reloadGrid');
                            });
                        } else {
    ...
    function ChangeStatus() {
        var md_sanpham_id = $('#grid_ds_sanphamhuy').jqGrid('getGridParam', 'selrow');
	...
	function funcPrintSP() {
        var poId = $('#grid_ds_sanphamhuy').jqGrid('getGridParam', 'selrow');
					...
					if (typeof printType != 'undefined') {
						if (printType == "printImportWebsite") {
							if (poId != null) {
								...
								window.open(printURL + "?md_sanpham_id=" + poId + "&trangthai=HHH", "In Thông Tin Sản Phẩm", windowSize);
							} else {
							...
							if (valueLike != null) {
								...
								window.open(printURL + "?md_sanpham_id=" + valueLike + "&trangthai=HHH", "In Thông Tin Sản Phẩm", windowSize);
							} else {
								alert('Bạn chưa chọn sản phẩm cần in.!');
							}
...
<DIV class="ui-layout-center ui-widget-content" id="lay-center-sanphamhuy">
    <uc1:jqGrid  ID="grid_ds_sanphamhuy" 
            SortName="ma_sanpham"
            SortOrder ="asc"
			BtnPrint="funcPrintSP"
            UrlFileAction="Controllers/ProductCancelController.ashx" 
            ...
            OnSelectRow = "function(ids) {
		                    if(ids == null) {
			                    ...
			                    if($('#grid_ds_quycachdonggoihuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_quycachdonggoihuy').jqGrid('setGridParam',{url:'Controllers/QuyCachDongGoiController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_quycachdonggoihuy').jqGrid().trigger('reloadGrid');
				                }
				                
				                if($('#grid_ds_giafobhuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_giafobhuy').jqGrid('setGridParam',{url:'Controllers/PriceFOBController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_giafobhuy').jqGrid().trigger('reloadGrid');
				                }
				                
				                if($('#grid_ds_gianoihuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_gianoihuy').jqGrid('setGridParam',{url:'Controllers/PriceSaleController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_gianoihuy').jqGrid().trigger('reloadGrid');
				                }
				                
				                if($('#grid_ds_khachhangdocquyen_sphuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_khachhangdocquyen_sphuy').jqGrid('setGridParam',{url:'Controllers/QuyDinhVoiKhachHangController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_khachhangdocquyen_sphuy').jqGrid().trigger('reloadGrid');
				                } 
				                
				                if($('#grid_ds_cangxuathanghuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_cangxuathanghuy').jqGrid('setGridParam',{url:'Controllers/CangXuatHangController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_cangxuathanghuy').jqGrid().trigger('reloadGrid');
				                } 
				                
				                if($('#grid_ds_bientauhuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_bientauhuy').jqGrid('setGridParam',{url:'Controllers/BienTauController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_bientauhuy').jqGrid().trigger('reloadGrid');
				                } 
				                
				                if($('#grid_ds_nhacungungmacdinhhuy').jqGrid('getGridParam','records') &gt; 0 )
			                    {
				                    $('#grid_ds_nhacungungmacdinhhuy').jqGrid('setGridParam',{url:'Controllers/NhaCungUngMacDinhController.ashx?&productId='+ids,page:1});
				                    $('#grid_ds_nhacungungmacdinhhuy').jqGrid().trigger('reloadGrid');
				                }
				            } 
				            else 
				            {
...
<DIV class="ui-layout-south" id="lay-south-sanphamhuy"> 
    <div class="ui-layout-center" id="tab-product-detailshuy">
        <ul>
		    ...
		    <div id="nav-tabs-1">
		        <uc1:jqGrid  ID="grid_ds_quycachdonggoihuy" 
		    ...
		    <div id="nav-tabs-2">
		        <uc1:jqGrid  ID="grid_ds_giafobhuy"
		    ...
		    <div id="nav-tabs-3">
		        <uc1:jqGrid  ID="grid_ds_gianoihuy"
                SortName="md_giasanpham_id" 
                UrlFileAction="Controllers/PriceFOBController.ashx" 
                ColNames="['md_giasanpham_id', 'Tên Phiên Bản','Tên Sản Phẩm', 'Giá'
                , 'Ðồng Tiền', 'Ngày Hiệu Lực', 'Ngày Tạo', 'Người Tạo', 'Ngày Cập Nhật', 'Người Cập Nhật', 'Mô tả', 'Hoạt động']"
		    ...
		    <div id="nav-tabs-4">
		        <uc1:jqGrid  ID="grid_ds_khachhangdocquyen_sphuy"
		    ...
		    <div id="nav-tabs-5">
		        <uc1:jqGrid  ID="grid_ds_cangxuathanghuy"
		    ...
		    <div id="nav-tabs-6">
		        <uc1:jqGrid  ID="grid_ds_bientauhuy"
		    ...
		    <div id="nav-tabs-7">
		        <uc1:jqGrid  ID="grid_ds_nhacungungmacdinhhuy"
